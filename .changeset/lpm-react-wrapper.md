...
<BancontactOneTimePaymentButton presentationMode="popup" createOrder={createOrder} onApprove={onApprove} />

// Split layout: named hook + standalone button
import { useBancontactOneTimePaymentSession, BancontactPaymentButton } from "@paypal/react-paypal-js/sdk-v6/local-payment-methods";
const bancontactSession = useBancontactOneTimePaymentSession({ createOrder, onApprove });
...
<LPMOneTimePaymentButton lpm={selectedLPM} createOrder={createOrder} onApprove={onApprove} />
```

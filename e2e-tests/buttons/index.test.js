...
describe("Buttons Component", () => {
    beforeEach(async () => {
        await Promise.all([
            page.goto(`${baseURL}/e2e-tests/buttons/index.html`, {
    ...
    it('should display the inline form when clicking the "Debit or Credit Card" button', async () => {
        ...
        const payWithCardButton = await iframe.waitForSelector(
        ...
        await page
            ...
            .waitForFunction(
                () =>
                    document.querySelector(".paypal-buttons").offsetHeight > 600
            );
    });
});

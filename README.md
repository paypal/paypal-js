...
```html
<script src="https://unpkg.com/@paypal/paypal-js@5.1.3/dist/iife/paypal-js.legacy.min.js"></script>
```
...
<html lang="en">
    <head>
        <script src="https://unpkg.com/@paypal/paypal-js@5.1.3/dist/iife/paypal-js.min.js"></script>
    </head>
    <body>

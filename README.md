...
```html
<script src="https://unpkg.com/@paypal/paypal-js@4.0.2/dist/iife/paypal-js.legacy.min.js"></script>
```
...
<html lang="en">
    <head>
        <script src="https://unpkg.com/@paypal/paypal-js@4.0.2/dist/iife/paypal-js.min.js"></script>
    </head>
    <body>

...
export type LPMOneTimePaymentButtonProps = UseLPMOneTimePaymentSessionProps &
  ButtonProps & {
     ...
     *
     * Pass a stable reference (e.g. from `useState`/`useMemo`, or defined
     * outside the component) rather than an inline object literal — a new
     * object on every render will re-run the payment fields effect below.
     */

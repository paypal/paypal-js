...
async function main() {
  ...
  config.allowedPaymentMethods[0].tokenizationSpecification.parameters.gateway;
  ...
  formattedConfig.allowedPaymentMethods[0].tokenizationSpecification.parameters
    .gateway;
}

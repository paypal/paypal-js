        ...
        (function () {
            ...
            (t.Set = function (e) {
                ...
                (t.idf = function (e, n) {
                    var r = 0;
                    for (var i in e)
                        i != "_index" && (r += Object.keys(e[i]).length);
                    var s = (n - r + 0.5) / (r + 0.5);
            ...
            (t.Pipeline = function () {
                ...
                (t.Pipeline.registerFunction = function (e, n) {
                    n in this.registeredFunctions &&
                        t.utils.warn(
                            "Overwriting existing registered function: " + n,
                        ),
                        (e.label = n),
...
`,
                    ...
                    return (
                        e.forEach(function (r) {
                            ...
                            if (i) n.add(i);
                                ...
                                throw new Error(
                                    "Cannot load unregistered function: " + r,
                                );
                        }),
                        n
                    );
            ...
            (t.Vector = function (e) {
                ...
                (t.Vector.prototype.magnitude = function () {
                    ...
                    for (
                        var e = 0, n = this.elements.length, r = 1;
                        r < n;
                        r += 2
                    ) {
                ...
                (t.Vector.prototype.toArray = function () {
                    for (
                        var e = new Array(this.elements.length / 2),
                            n = 1,
                            r = 0;
            ...
            (t.Builder = function () {
                    ...
                    for (var s = 0; s < i.length; s++) {
                        ...
                        for (var v = 0; v < d.length; v++) {
                            ...
                            this.invertedIndex[x][o][r] == null &&
                                (this.invertedIndex[x][o][r] =
                                    Object.create(null));
                            for (
                                var g = 0;
                                g < this.metadataWhitelist.length;
                                g++
                            ) {
                ...
                (t.Builder.prototype.calculateAverageFieldLengths =
                    function () {
                        for (
                        ...
                        for (
                            var c = Object.keys(this._fields), s = 0;
                            s < c.length;
                            s++
                        ) {
                            var l = c[s];
                ...
                (t.MatchData.prototype.combine = function (e) {
                    for (
                        var n = Object.keys(e.metadata), r = 0;
                        r < n.length;
                        r++
                    ) {
                        var i = n[r],
                        ...
                        for (var o = 0; o < s.length; o++) {
                            ...
                            for (var l = 0; l < c.length; l++) {
                                ...
                                this.metadata[i][a][d] == null
                                    ? (this.metadata[i][a][d] =
                                          e.metadata[i][a][d])
                                    : (this.metadata[i][a][d] = this.metadata[
                                          i
                                      ][a][d].concat(e.metadata[i][a][d]));
                            }
                        }
                    }
                }),
                (t.MatchData.prototype.add = function (e, n, r) {
                    ...
                    for (var i = Object.keys(r), s = 0; s < i.length; s++) {
                        ...
                        o in this.metadata[e][n]
                            ? (this.metadata[e][n][o] = this.metadata[e][n][
                                  o
                              ].concat(r[o]))
                ...
                (t.Query.prototype.clause = function (e) {
                    return (
                        ...
                        e.wildcard & t.Query.wildcard.TRAILING &&
                            ...
                            (e.term = "" + e.term + "*"),
                        "presence" in e ||
                            (e.presence = t.Query.presence.OPTIONAL),
                        this.clauses.push(e),
                        this
                    );
                }),
                ...
                (t.QueryLexer.lexTerm = function (e) {
                    if (
                        (e.width() > 1 &&
                            (e.backup(), e.emit(t.QueryLexer.TERM)),
                        e.ignore(),
                        e.more())
                    )
        ...
        updateIndexVisibility() {
            ...
            e && (e.open = !0),
                document.querySelectorAll(".tsd-index-section").forEach((r) => {
                    ...
                    let i = Array.from(
                        r.querySelectorAll(".tsd-index-link"),
                    ).every((s) => s.offsetParent == null);
        ...
        ensureFocusedElementVisible() {
            if (
                (this.alwaysVisibleMember &&
                    (this.alwaysVisibleMember.classList.remove(
                        "always-visible",
                    ),
            ...
            if (n.offsetParent == null) {
                (this.alwaysVisibleMember = n),
                    n.classList.add("always-visible");
